<template>
    ...
    <main class="xl:px-72 bg-fundo mx-auto container-xl telaTotal marginTela">
        <div class="h-full flex bg-red-500 justify-center">
            <div
                class="max-w-[800px] w-full mx-3 bg-gray-300 blocoTela mt-10 grid"
            >
                <div
                ...
                <div class="bg-blue-500">
                    <div class="grid post-grid-template gap-3">
                        <div class="w-12 h-12 bg-perfis rounded-full"></div>
                        <div class="grid gap-1">
                            <div class="bg-green-300 h-[50px] flex items-center gap-5">
                                <h2>Maria Teste dos Santos</h2>
                                <p>teste</p>
                            </div>
