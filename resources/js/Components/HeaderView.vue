  ...
  <header class="bg-fundo-pagina">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <input type="search" class="appearance-none w-[520px] rounded-lg bg-fundo-post focus:outline-none focus:ring-0 focus:border-transparent px-[20px] text-color1" placeholder="Buscar. . .">
      ...
      <DialogPanel class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
        ...
        <div class="mt-6 flow-root">
          <div class="-my-6 divide-y divide-gray-500/10">
            ...
            <div class="py-6">
              <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Entrar</a>
            </div>
          </div>
        </div>
      </DialogPanel>
