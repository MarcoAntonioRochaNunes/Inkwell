        ...
        <div class="mb-5">
            <div class="mb-5">
                <div class="flex gap-2 items-center">
                    <div class="h-14 w-14 rounded-full bg-fundo-post"></div>
                    <div class="grid">
                        <span aria-hidden="true" class="text-sm font-semibold text-white">Tom Cook</span>
                        <span class="text-xs italic text-gray-300">@tomCooking</span>
                    </div>
                </div>
                <span class="sr-only">Your profile</span>
                <div class="flex text-sm/6 text-gray-300 gap-2 font-semibold py-3 px-3 justify-between">
                    <div class="grid">
                        <span class="text-orange-400">600.M</span>
            ...
            <div class="flex justify-center font-semibold">
                <Link :href="route('profile.edit')" class="text-white font-medium py-2 px-12 border border-white rounded-lg hover:bg-white hover:text-black ">Ver Perfil</Link>
            </div>
        </div>
        <nav class="flex flex-1 flex-col pl-9">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            <li>
              <ul role="list" class="-mx-2 space-y-1">
                <li v-for="item in navigation" :key="item.name">
                  <a :href="item.href" :class="[item.current ? 'text-orange-500' : 'text-gray-400 hover:bg-orange-800 hover:text-white', 'group flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold']">
                    <component :is="item.icon" class="size-6 shrink-0" aria-hidden="true" />
                    {{ item.name }}
                  </a>
                </li>
              ...
              <div class="grid mt-2">
                <hr>
                    <a href="#" class="mt-7 text-fundo-pagina text-center bg-white hover:bg-gray-200 hover:text-black py-2 px-6 gap-x-3 rounded-md p-2 text-sm/6 font-semibold ">
